...
export default function AdminAnalytics() {
  ...
  const cards = [
    { icon: Download, label: "Total Downloads", value: formatFull(data?.total_downloads || 0), color: "#FFC107" },
    { icon: Package, label: "Total Apps", value: data?.total_apps || 0, color: "#229ED9" },
    { icon: MessageSquare, label: "Reviews", value: data?.total_reviews || 0, color: "#22C55E" },
    { icon: Ticket, label: "Redeem Codes", value: data?.total_codes || 0, color: "#EC4899" },
  ];
