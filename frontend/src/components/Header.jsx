...
export const Header = () => (
  <header
    ...
    className="sticky top-0 z-40 border-b border-[#E5E7EB] bg-white/80 backdrop-blur-xl"
  >
    <div className="flex items-center justify-between px-4 py-3">
      <Link to="/" data-testid="logo-link" className="flex items-center gap-2">
        ...
        <div className="leading-none">
          <span className="font-display text-[15px] font-extrabold tracking-tight text-[#111111]">
            Uonogames
          </span>
          <span className="font-display text-[15px] font-extrabold tracking-tight text-[#FFB300]">
            apk
          </span>
        </div>
      </Link>
